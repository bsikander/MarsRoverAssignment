...
public class TestRoverMovements {
	...
	public void testRoverMoveForwardFrom00NTo01N()
	{
		...
		rover.move();
		assertEquals(rover, new Rover(new Point(0,1), new SimpleCardinalPoints('N')));
	}
	...
	public void testRoverMoveForwardFrom00ETo10E()
	{
		...
		assertEquals(rover, new Rover(new Point(1,0), new SimpleCardinalPoints('E')));
	}
	...
	{
		Rover rover = new Rover(new Point(0,5), new SimpleCardinalPoints('N'));
		assertEquals(rover.move() , false);
	}
	...
	{
		Rover rover = new Rover(new Point(5,0), new SimpleCardinalPoints('E'));
		assertEquals(rover.move() , false);
	}
	...
	{
		Rover rover = new Rover(new Point(0,5), new SimpleCardinalPoints('W'));
		assertEquals(rover.move() , false);
	}
